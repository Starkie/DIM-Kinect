...
namespace EsqueletoGestos
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// <summary> Thickness of body center ellipse </summary>
        private const double BodyCenterThickness = 10;

        /// <summary> Thickness of clip edge rectangles </summary>
        private const double ClipBoundsThickness = 10;

        /// <summary> Brush used to draw skeleton center point </summary>
        ...
        /// <summary> Pen used for drawing bones that are currently tracked </summary>
        ...
        /// <summary> Drawing group for skeleton rendering output </summary>
        ...
        /// <summary> Draws indicators to show which edges are clipping skeleton data </summary>
        ...
        /// <summary> Execute startup tasks </summary>
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            // Look through all sensors and start the first connected one. This requires that a
            // Kinect is connected at the time of app startup. To make your app robust against
            // plug/unplug, it is recommended to use KinectSensorChooser provided in Microsoft.Kinect.Toolkit
        ...
        /// <summary> Event handler for Kinect sensor's SkeletonFrameReady event </summary>
        /// <param name="sender"> object sending the event </param>
        /// <param name="e"> event arguments </param>
        ...
        /// <summary> Draws a skeleton's bones and joints </summary>
        ...
        {
            // Convert point to depth space. We are not using depth directly, but we do want the
            // points in our 640x480 output resolution.
            DepthImagePoint depthPoint = this.sensor.CoordinateMapper.MapSkeletonPointToDepthPoint(skelpoint, DepthImageFormat.Resolution640x480Fps30);
            return new Point(depthPoint.X, depthPoint.Y);
        }

        /// <summary> Draws a bone line between two joints </summary>
        ...
        /// <summary> Handles the checking or unchecking of the seated mode combo box </summary>
        /// <param name="sender"> object sending the event </param>
        /// <param name="e"> event arguments </param>
